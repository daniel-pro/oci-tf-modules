variable "marketplace_source_images" {
  ...
  default = {
    nfw_byol_mktpl_image = {
      ocid = "ocid1.image.oc1..aaaaaaaanpksmmpiiivivn5kgqgyxlrbfihf4knkcw5tz3qmgsqzqg7hc2ia"
      is_pricing_associated = true
      compatible_shapes = ["VM.Standard.3.Flex", "VM.Optimized3.Flex"]
    }
