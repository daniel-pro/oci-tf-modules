...
variable "route_tables" {
  description = "List of route tables - with their correspondent route rules"
  type        = any
  default     = {}
}
...
#security lists to attach to the subnets
variable "subnet_security_lists" {
  description = "Security Lists to attach to the subnets"
  type        = any
  default     = {}
}
...
variable "security_lists" {
  description = "Security Lists to be created"
  type        = any
  default     = {}
}
